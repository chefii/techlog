...
------------------------------------------------------------
**배움에 목마르고, 소통으로 팀 성장을 이끄는 3년차 서버 백엔드/풀스택 엔지니어**  (SI/SM + 서비스 기업 | 경력 2년 10개월 | 위즈컨 재직 중 - 대리)🔹 **핵심 스택**: Java/Spring(Boot/MVC/Framework/MyBatis), Node.js, AWS/NCP DevOps(Jenkins/EC2/Nginx), DB(MySQL/Oracle/PostgreSQL/MongoDB)  🔹 **비즈니스 임팩트 창출자**: "코드 한 줄의 ROI" 믿음으로 12+ 프로젝트(B2B/C2C 플랫폼, 공공/안전교육) 수행     - **Zero-Downtime NCP 마이그레이션**: 운영 비용 **30% 절감**, 무중단 배포/헬스체크 구축     - **쿼리 튜닝 & 인덱스 최적화**: 성능 **70%↑ (조회 50%↑)**     - **APM(Scouter) 모니터링**: 메모리 **25%↓**, 장애 처리 시간 단축     - **Excel 자동화 & AI 챗봇/멘토링**: 관리 효율 **40%↑**, 수료율 **85% 달성**  **ROI 중심 기술 리더**로 귀사의 플랫폼 스케일링 & 혁신에 기여하겠습니다!
